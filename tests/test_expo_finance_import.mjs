...
import { canConfirmImport, confirmImportPayload, importAmount, importPayload, isImportRequestId, newImportRequestId, readImportPreview, readImportReceipt } from '../frontend/src/lib/financeImport.ts';

const id = 'a'.repeat(32);
const file = { name: 'synthetic.csv', contentBase64: 'YWJj', encoding: 'auto' };
const row = { line: 2, title: '合成咖啡', date: '2026-09-01', amountCents: 123456, currency: 'CNY', flow: 'expense', duplicate: false, conflict: false };
