...
- 相册支持真实图库、详情编辑、家庭共享、逐电视许可和 Google 选片/确认；旅行支持基本计划、准备/采购、预览和确认；助理支持真实请求预览、选择性保存和执行回执。资金仍提供概要，详细财务、复杂旅行分段／资料／云发布、照片旅行推荐、账户连接及家庭／设备／布局管理可进入明确标注的 `/classic` 功能。
