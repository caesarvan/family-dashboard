...
export type ListItem = BaseItem & { done: boolean; due?: string; priority?: ShoppingPriority; quantity?: string; budget?: number | null; tripId?: string; actual?: number | null; photoIds?: string[] };
...
export type ScreenProps = {
  ...
  onAccountPending?: (pending: boolean) => void;
