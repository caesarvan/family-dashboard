  ...
  return <View style={styles.page}>
    ...
    {privateVisible && data && <>
      ...
      {!detail ? <>
        ...
        <View style={styles.row}><Button icon="chart-donut" accessibilityLabel="资产与投资管理" disabled={locked} onPress={() => props.onLegacy('finance')}>资产与投资管理</Button><Button icon="folder-outline" accessibilityLabel="来源报告与高级财务" disabled={locked} onPress={() => props.onLegacy('finance')}>来源报告与高级财务</Button></View><Text style={styles.muted}>资产、持仓导入与来源报告暂在经典财务页面管理。</Text>
      </> : <>
