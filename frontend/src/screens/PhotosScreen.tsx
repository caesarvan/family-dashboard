...
function PhotoWorkspace(props: ScreenProps & { identityKey?: string }) {
  ...
  return <View style={styles.page}>
    <PageHeader title="相册" description="自己留下，按你的选择分享。" action={<View style={styles.actions}><Button mode="outlined" icon="television" disabled={busy || !!editor || importOpen || !!createReceipt || !!confirmReceipt} onPress={() => props.onNavigate('devices')}>电视与播放</Button><Button mode="contained" icon="plus" disabled={busy} onPress={() => setImportOpen(value => !value)}>选择照片</Button></View>} />
