...
function Workspace(props: Props & { identityKey: string }) {
  ...
  function selectPayment(payment: Payment) { if (locked || unknown || !model.choices || !payment.eligible) return; install({ draft: { operation: 'apply', journey: model.choices.journey, payment, amount: '' }, selecting: false, preview: null }); }
