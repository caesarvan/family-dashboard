...
export type WorldMapProps = { routeMap?: RouteMap; selectedRouteIndex?: number; onRouteSelect?: (index: number) => void; places: Place[]; selected?: string; disabled?: boolean; picking?: boolean; picked?: Coordinates | null;
