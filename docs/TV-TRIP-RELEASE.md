...
本工具准备固定五服务候选，不表示已发布。父版为实际 `e8f0427b35157074d179bc4de86a7c5c4db0a755`，镜像 `e5195f8d…`；新包沿 `build_tv_trip_release` 的完整源码、导出和镜像校验。父库组是 75/9，新库组是 77/9，只增加电视旅行选择及操作回执两表。
