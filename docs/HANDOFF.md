...
本批源码合入main `1d589e6d401d2d760f7361a2cab36839841a7208` 时，比实际包source多README和三份discovery后验文档，运行源码相同；后续纯文档提交仍不改变已安装身份。财务收支方向[PR #47](https://github.com/caesarvan/family-dashboard/pull/47)仍是独立分支候选，尚未发布。本人A–D仍0/4，真实账号、手机与实体电视另验。
