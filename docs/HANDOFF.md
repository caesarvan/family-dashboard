...
视频处理及混合电视播放保留在 [草稿 PR #19](https://github.com/caesarvan/family-dashboard/pull/19)，未进入本次部署。正式构建、临时浏览器、真实 Linux 两户三库迁移和两项媒体资源实验已分段通过；服务器候选已准备，完整五服务控制器演练、最终计划审查与激活仍未完成。具体身份、失败历史和边界见[视频发布候选进展](MEDIA-VIDEO-ACTIVATION.md#2026-09-20-候选验证进展)。A–D 本人完整验收仍 0/4，真实云目标待选，实体电视暂无法验证。
