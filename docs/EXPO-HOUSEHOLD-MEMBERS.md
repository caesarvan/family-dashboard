...
本批自 `eda8632719a6f1a3202e6d5c2a9a986329c9c287` 开发，已于北京时间 2026-09-18 05:49:18 激活；05:49:55 post 通过，05:55:19 独立读回及随后审计通过。实际运行身份、迁移和本地／Linux 验证见[集中验收](EXPO-HOUSEHOLD-MEMBERS-ACCEPTANCE.md#household-members-release)。现有两位成员迁移为共同管理员；家庭角色与成员／电视认证身份分开。本人登录设备仍使用既有入口，本面板不重建它。
