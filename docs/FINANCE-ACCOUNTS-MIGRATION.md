...
实际命令：`.venv/Scripts/python.exe -B -X utf8 -m pytest tests/test_finance_accounts_migration.py tests/test_investment_operation_migration.py -q --junitxml=test-results/finance-accounts-migration-r1/results.xml`。首轮 **42 passed（新 33、旧 9），73.22 秒，零失败／错误／跳过**；JUnit SHA-256 `ba2234d4256d83963e8e67303138f6556da6bc913025d22b33b55df37403e212`，stdout `6ff9cfeb361621c79f720a77a27dc33102f2cae9b418b9e7154b1af858f45651`，stderr 为空。原件只留作者 worktree 的 `test-results/finance-accounts-migration-r1/`，不入库；测试后仅补本文记录。未进行服务器、Docker、真实家庭数据或生产恢复演练。
