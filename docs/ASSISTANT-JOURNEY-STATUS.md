...
1. 自然语言自动进入本地状态查询，必须同时出现明确旅行上下文（`旅行 / 行程 / 旅游`）和状态词组；例如“冰岛旅行准备得怎么样”“冰岛行程准备进度”“旅行还有什么没办”。首版状态词组限于 `准备得怎么样 / 准备怎么样 / 准备情况 / 准备进度 / 还有什么没办 / 还有哪些没办 / 还有什么没做 / 还有哪些没做 / 还有什么未完成 / 还有哪些未完成`，不承诺任意问法理解。没有旅行上下文的“还有哪些没做”“还有什么未完成”保留原泛化/任务入口，不能自动转为旅行查询。用户主动点击“查询旅行准备情况”按钮，或已经在该状态页时，才可用空旅行名或这些短问句进入候选选择。
...
- 分流正负对照：“冰岛旅行还有哪些没做”进入旅行状态；普通助理输入“还有哪些没做”“还有什么未完成”仍走原家庭入口。主动点击“查询旅行准备情况”或在状态页输入同样短问句才显示旅行候选，空旅行名不自动选最近一趟。
