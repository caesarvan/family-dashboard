...
本脚本为独立验收工具，已有初轮实际执行但尚未整轮通过，不代表功能已验收或发布。使用真实 Expo 导出、Edge、临时 HTTPS Flask 和 SQLite；所有账号、邀请和私人财务资料均为合成。界面的注册、绑定、邀请、加入、切换、移除、退出和个人登出必须实际点击，API 仅用于建立旧身份／第二家庭／私人资料及核对持久结果。
