        ...
        try:
            ...
            with ZipFile(output, 'w', compression=ZIP_DEFLATED, compresslevel=6) as archive:
                ...
                entry('README.txt', ['家庭中枢 · 个人数据副本\n\n',
                    ...
                    'personal.householdMedia 仅含本人已确认保存照片的说明、尺寸、来源文件名与旅行关联；shared.householdMedia 仅含仍获授权的伙伴共享照片说明，不包含原始文件名。没有照片文件、视频文件、下载网址、选片清单、令牌、TV许可或后台任务。媒体类型、视频时长和音轨状态属于说明字段；加密展示副本和后台记录仅在服务器整库备份中保留。\n',
