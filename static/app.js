...
async function refresh(force=false){
  ...
  try{const next=await api('/state');const changed=force||!data||next.revision!==data.revision;data=next;online=true;lastFetch=displayTime(new Date());if(changed)renderBoard();else updateFooter()}
