...
**最新上线：采购关联库存与首页待办编辑（2026-09-18 15:12:56，北京时间）。** 采购项可打开「登记或查看库存」，明确登记批次、收货和退回，再返回原搜索/筛选；首页本地待办可编辑负责人和截止日期。浏览器五条流程分轮取得证据，Linux 47 项与两户三库演练通过；生产实际一户两库保持 61/9，15:14:36 独立只读审计通过。本人真实库存、云端交互和实体电视仍待验收。完整身份与边界见[本批验收](docs/SHOPPING-INVENTORY-ACCEPTANCE.md#shopping-inventory-release)。
