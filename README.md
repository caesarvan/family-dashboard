...
**最新上线：本地日程默认私密与明确共享，2026-09-20 10:11:17（北京时间）激活，10:18:48 独立生产只读审计通过。** 从首页或日程添加安排，默认「仅自己」；明确选择「家庭共享」后才向家庭成员和电视展示，创建者可收回共享。旧记录与已授权云来源保持原范围。[使用与集中验收](docs/CALENDAR-PRIVACY-ACCEPTANCE.md#calendar-privacy-release)。
