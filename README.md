...
**最新上线：视频导入、成员播放与电视混合轮播。** 2026-09-20 17:26:15（北京时间）激活，17:33:17 生产只读检查通过，随后非作者复核通过。相册支持明确选择并保存视频、成员播放和逐台授权的照片／视频轮播；真实 Google 视频和实体电视仍待验。[使用、固定运行身份与集中验收](docs/MEDIA-VIDEO-ACCEPTANCE.md#media-video-release)。设备本地照片上传和「那年今日」仍为独立候选。
