...
**候选未上线：电视单趟旅行回顾。** 从保存的旅行进入回顾，选择一台已配对电视与可选共享路线，核对获准内容后明确开始；没有媒体但有可展示路线也可回顾。每台电视独立授权，撤权或旅行失效不退回全相册。[候选使用说明](docs/TV-TRIP-USER-GUIDE.md)与[接口合同](docs/TV-TRIP-PLAYBACK.md)说明恢复及隐私边界；本地77/9不改变上述生产75/9。
