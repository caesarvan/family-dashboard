...
**候选已验证、尚未发布：本人旅行费用归集。** 从已保存旅行选择本人人民币付款，预览确认后与共享预算并列核对；退款或来源变化进入“需核对”，可追溯原付款、调整或解除。真实组合浏览器与隔离 Linux 46 项、73→75 两户三库演练已执行通过，Linux 与迁移非作者执行审查尚待完成；生产仍为上方财务 `53ea`／73/9。[候选使用与验收](docs/JOURNEY-FINANCE-ACCEPTANCE.md#journey-finance-candidate)。
