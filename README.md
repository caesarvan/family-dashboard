...
家庭／成员及照片旅行推荐继续保留经典入口；资产来源更新已迁入 Expo；本人资产来源报告、旅行资料和行程分段已迁入 Expo；设备、布局管理与电视展示页均已迁入 Expo，经典电视渲染器保留为明确回退入口。财务账本、本人持仓、地图、家庭物品及旅行日历同步主流程已迁入 Expo；电视继续独立只读 `/tv`。路线、精选回顾、视频、iCloud／NAS、通用成员角色和完整跨模块场景仍在 [产品计划](docs/PRODUCT-PLAN.md) 中逐项跟踪。
