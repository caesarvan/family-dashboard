...
**最新上线：通用账单四列映射（2026-09-18 06:56，北京时间）。** 在「家庭资金 → 导入账单」选择通用表格，可手动指定日期、金额、标题和币种列，预览无错误后再明确保存。仅本人可见，不换汇或修改公共荷包。[使用步骤](docs/EXPO-FINANCE-COLUMN-MAPPING.md) · [本批验收记录](docs/FINANCE-COLUMN-MAPPING-ACCEPTANCE.md)。
