...
**本地候选，尚未部署：成员外观设置。** 新版「更多 → 外观设置」可为本人选择浅色／深色、标准／紧凑密度，明确保存后应用；伴侣和每台电视保持各自设置。操作与失败恢复见 [成员外观](docs/EXPO-APPEARANCE.md)。候选已完成接口、类型与定向 Node 检查，组合浏览器及发布仍待实际验证；当前线上仍为下方 14:56 首页布局版。
