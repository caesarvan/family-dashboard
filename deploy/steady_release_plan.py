...
from deploy import steady_release_controller as controller
...
OPERATORS = ('steady_release_controller.py', 'steady_release_package.py', 'steady_release_data.py', 'steady_release_plan.py',
...
def assemble(package_dir, package_sha256, build_dir, build_sha256, validation_dir,
    ...
    plan = {'schemaVersion': 1, 'kind': 'steady-release-plan', 'packageSha256': package_sha256,
