"""Photo metadata update on the installed five-service 75/9 database group."""
...
class Controller(shared.Controller):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs, mode='media-date-source-update')
...
def main(argv=None):
    return shared.main(argv, mode='media-date-source-update')
