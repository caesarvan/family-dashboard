...
OPERATORS = ('finance_analysis_release_controller.py', 'finance_analysis_release_package.py', 'finance_analysis_release_data.py', 'finance_analysis_release_plan.py',
...
def assemble(package_dir, package_sha256, build_dir, build_sha256, validation_dir,
    ...
    plan = {'schemaVersion': 1, 'kind': 'finance-analysis-release-plan', 'packageSha256': package_sha256,
