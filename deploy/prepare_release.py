...
FILES = ['app.py','frontend_runtime.py','member_sessions.py','household_members.py','household_memberships.py','personal_accounts.py','membership_storage.py','membership_http.py','tv_display.py','sync_health.py','cloud_accounts.py','cloud_providers.py','sync_worker.py','shopping_media.py','shopping_settlement.py','household_routines.py','spending_observations.py',
