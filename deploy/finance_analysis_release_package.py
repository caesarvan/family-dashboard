"""Fixed order-inventory R1 analysis migration entry point; shared package/build checks stay strict."""
import argparse
import json
...
from deploy.finance_analysis_release_profile import BASELINE
